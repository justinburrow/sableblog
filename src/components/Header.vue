      ...
      <div class="header__content container-full">
        ...
        <div class="navigation only-desktop">
          <ul>
            ...
            <li class="commitment" @mouseenter="showDropdown = false, bloghover = false; searchHover = false;" @click="setActive('commitment')" :class="{active: isActive('commitment')}"><a href="/pages/our-commitment/">Our Commitment</a></li>
